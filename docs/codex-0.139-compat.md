...
SKS 7.2.1 keeps the historical Codex 0.139 compatibility notes as a fallback baseline while the active release-authorizing Codex surface is `rust-v0.145.0`.
