...
SKS 8.1.0 release proof truth requires package metadata, the root lockfile
...
SKS 8.1.0 must not claim that a required live gate passed when credentials or
...
receipts cannot serve as 8.1.0 evidence.
