...
SKS 8.0.5 release proof truth requires package metadata, the root lockfile
...
SKS 8.0.5 must not claim that a required live gate passed when credentials or
...
receipts cannot serve as 8.0.5 evidence.
