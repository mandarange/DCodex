...
SKS 8.1.1 release proof truth requires package metadata, the root lockfile
...
SKS 8.1.1 must not claim that a required live gate passed when credentials or
...
receipts cannot serve as 8.1.1 evidence.
