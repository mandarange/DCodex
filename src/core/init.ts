...
const AGENTS_BLOCK = [
  ...
  '- Use gpt-6-astra for every subagent; vary reasoning effort by the slice: Astra Low for tiny mechanical work, Astra High for implementation, Astra Medium for read-heavy context or direct tool operation, and Astra Max only for focused judgment, risk, or final review.',
  ...
  '- Never run `sks doctor --fix` yourself. When repair is needed, tell the user to run it in their own terminal and wait for confirmation.',
