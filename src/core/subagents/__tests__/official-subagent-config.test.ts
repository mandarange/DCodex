...
test('generated Naruto skill describes the official workflow and retired aliases stay absent', async () => {
  ...
  assert.match(naruto, /Route tiny mechanical and mass shards to Luna Max, broad search and exploration shards to Terra Medium, and implementation or judgment to Sol/)
