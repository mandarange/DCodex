...
const required = {
  ...
  'docs/codex-cli-compat.md': ['rust-v0.146.0', 'minimumSupportedVersion', '0.146.0', 'SubagentStart', 'sks_zero_warning_disallowed', 'strict subset'],
  'docs/codex-app.md': ['rust-v0.146.0', 'App Server v2', 'Codex Chrome Extension', 'gpt-image-2'],
  'docs/official-docs-compat.md': ['official-docs-compat-report.js', 'rust-v0.146.0', 'gpt-image-2', 'input_fidelity', 'additionalProperties:false'],
